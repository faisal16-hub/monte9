    ...
    <div className="pt-20 min-h-screen bg-[#E9E4D8]">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 style={{ color: '#416D50', marginBottom: '16px' }}>Our Excellent</h2>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
                  ...
                  <div className="p-6">
                    <p style={{ fontSize: '11px', color: '#B08C44', marginBottom: '8px', letterSpacing: '1px' }}>
                      {service.label}
                    </p>
                    <h4 style={{ color: '#416D50', marginBottom: '12px' }}>{service.title}</h4>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 style={{ color: '#416D50', marginBottom: '16px' }}>What Make Us</h2>
            <h2 style={{ marginBottom: '24px' }}>Different?</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {differentiators.map((item, index) => (
              ...
              >
                <div className="w-16 h-16 bg-[#416D50] rounded-full mx-auto mb-6 flex items-center justify-center">
                  <item.icon size={32} color="#fff" />
                </div>
                <h5 style={{ color: '#416D50', marginBottom: '12px' }}>{item.title}</h5>
                <p style={{ fontSize: '13px', color: '#666', lineHeight: '1.6' }}>
                  {item.description}
                </p>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h2 style={{ color: '#416D50', marginBottom: '8px' }}>Our Story</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-[#416D50] text-white rounded-xl p-12 relative">
                <div className="absolute top-8 right-8 w-24 h-24 bg-white rounded-full" />
                
                <div className="relative z-10">
                  <h3 className="text-white mb-4">Meet and talk with our sales team</h3>
                  ...
                  <div className="bg-white text-black rounded-xl p-6 mb-6">
                    <h4 style={{ fontSize: '23px', color: '#416D50', marginBottom: '8px' }}>AHMED OMAR</h4>
                    <p style={{ fontSize: '16px', color: '#666' }}>Sales Team Leader</p>
                  </div>

                  <button className="bg-[#B08C44] text-white px-8 py-3 rounded-lg hover:bg-[#9a7838] transition-colors">
                    Book a meeting
                  </button>
                </div>
              </div>
      ...
      <section className="py-20 bg-[#E9E4D8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="mb-16"
          >
            <h2 style={{ color: '#416D50', marginBottom: '8px' }}>What we have done &</h2>
            <h2 style={{ marginBottom: '16px' }}>what our Customers say</h2>
          ...
          <div className="relative">
                ...
                >
                  <div className="mb-4">
                    <div className="flex gap-1 mb-4">
                      {[...Array(5)].map((_, i) => (
                        <span key={i} className="text-[#B08C44]">★</span>
                      ))}
                    </div>
                    <p style={{ fontSize: '13px', color: '#666', lineHeight: '1.6' }}>
                      {testimonial.text}
                  ...
                  <div className="pt-4 border-t">
                    <h5 style={{ fontSize: '16px', color: '#416D50', marginBottom: '4px' }}>
                      {testimonial.name}
                    </h5>
                    <p style={{ fontSize: '13px', color: '#999' }}>{testimonial.role}</p>
                  </div>
                </motion.div>
              ))}
            </div>
            ...
            <div className="flex justify-center gap-4 mt-8">
              <button
                ...
                className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-lg hover:bg-[#416D50] hover:text-white transition-colors"
              >
                <ChevronLeft size={24} />
              </button>
              <button
            ...
            {team.map((member, index) => (
              ...
              >
                <div className="mb-4">
                  ...
                  <p style={{ fontSize: '13px', color: '#666' }}>{member.role}</p>
                </div>
              </motion.div>
            ))}
          </div>
